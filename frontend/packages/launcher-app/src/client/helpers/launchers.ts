...
export function fillPropsValuesWithEnums(propsContainer: { props?: FieldProperty[]; }, enums: Enums): { props?: FieldProperty[]; } {
...
function copyProperties(obj: any, props: any, lambda?: any): any {
  const result = {};
