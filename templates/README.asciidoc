...
By default this creates a new Launcher application containing the latest version of the https://hub.docker.com/r/fabric8/launcher-backend/[backend] services as found on Docker Hub.
